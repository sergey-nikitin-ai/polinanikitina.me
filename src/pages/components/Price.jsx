        ...
        <div class="container px-4 py-5" id="price">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-2 g-4 py-5">
                <div class="col d-flex align-items-start">
                    <div class="ps-4">
                        ...
                        <h3 class="fw-bold mb-3 fs-4">
                            <div>Диагностика ребёнка от 4 до 18 лет - 3000 ₽</div>
                        </h3>
                        <div>
                ...
                <div class="col d-flex align-items-start">
                    <div class="ps-4">
                        <h3 class="fw-bold mb-3 fs-4">
                            <div>Консультация в кабинете (1 час) - 3500 ₽</div>
                        </h3>
                        <div>
                ...
                <div class="col d-flex align-items-start">
                    <div class="ps-4">
                        <h3 class="fw-bold mb-3 fs-4">
                            <div>Сеанc терапии (1 час 30 мин.) - 4000 ₽</div>
                        </h3>
                        <div>
                        По результатам диагностики составляется индивидуальный план коррекционно-развивающей работы. 
                        Индивидуально подбираются терапевтические методы, инструменты и их сочетания (сказочная терапия, песочная терапия, КПТ терапия, АСТ терапия, ART терапия, МАК карты и д.р.). 
                        Коррекционно-развивающие занятия помогают ребёнку справляться с эмоциями, становиться увереннее в себе и раскрывать свой потенциал. 
                        </div>
                    </div>
                </div>
            </div>
